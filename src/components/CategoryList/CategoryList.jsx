...
const deleteByCategoryId=async (categoryId)=>{
  ...
  return (
    <div className='category-list-container' style={{height:'100vh', width:'100%',overflowY:'auto',overflowX:'hidden'}}>
  ...
  {category.items === 0 
    ...
    : `${category.items} ${category.items === 1 ? "Item" : "Items"}`}
                ...
                <div>
                  <button className='btn btn-sm btn-danger mt-3' onClick={()=>deleteByCategoryId(category.categoryId)}>
